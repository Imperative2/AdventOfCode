...
public class Day4 
{
	...
	public static void main(String[] args)
	{
		...
		{
			//System.out.println(sortedMessages[i].getMessage()+" "+sortedMessages[i].getGuardId());
		}
		...
		for(Guard guard : guardArray)
		{
			...
			System.out.println(" guard id: "+guard.id+" minute slept most: "+guard.minuteSleptMost()+" time : "+guard.timeSleptMostMinute());
		}
		
		System.out.println("Most sleepy guard: "+ mostSleepyGuard.getId()+" minute slept most: "+mostSleepyGuard.minuteSleptMost());
